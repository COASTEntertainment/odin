...
void odin_vertex_buffer_create(odin_render_device render_device, odin_vertex_buffer* vertex_buffer, odin_vertex_assembly vertex_assembly, void* vertex_data);
