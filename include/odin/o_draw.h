...
void ( *odin_draw_prepare_window)(odin_render_device render_device, odin_window window, odin_render_pass* present_pass);

/* Draw the frame. */
void ( *odin_draw_frame_window)(odin_render_device odin_render_device, odin_window window, odin_draw_func draw_func, void* user_data);

/* Tell the API to stop rendering and deletes no longer  */
void ( *odin_draw_done_window)(odin_render_device render_device, odin_window window);
...
void ( *odin_draw_command_bind_pipeline)(odin_render_device render_device, odin_draw_data draw_data, odin_pipeline pipeline);

/* Sets the vertex buffer to be bound. */
void ( *odin_draw_command_bind_vertex_buffer)(odin_render_device render_device, odin_draw_data draw_data, odin_vertex_buffer vertex_buffer);

/* Sets the current index buffer to be bound. */
void ( *odin_draw_command_bind_index_buffer)(odin_render_device render_device, odin_draw_data draw_data, odin_index_buffer index_buffer);

/* Draws a vertex buffer and index buffer. */
void ( *odin_draw_command_indexed)(odin_render_device render_device, odin_draw_data draw_data, int index_count);
