...
void ( *odin_get_physical_device_properties)(odin_render_device render_device, odin_physical_device physical_device, odin_physical_device_properties* properties);

/** \brief Sets a physical device to be used at runtime when rendering */
void ( *odin_set_physical_device)(odin_render_device render_device, odin_physical_device physical_device);
